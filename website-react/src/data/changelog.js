...
export const CHANGELOG = [
  {
    ...
    entries: [
      ...
      { type: "new", text: "4 new achievements for topping your friend circle's weekly leaderboard" },
      ...
      { type: "fix", text: "Fixed the Save as Template button showing for Free tier, which can't use templates, and being hard to read for everyone else" },
      { type: "fix", text: "Fixed Streak Rescue showing the wrong price in the shop" },
      ...
      { type: "change", text: "Achievement medals now use proper icons instead of a star rating" },
      { type: "removed", text: "Removed Extra Loot Pull from the shop — it was a disguised gamble, not a fair deal" },
      { type: "change", text: "Updated our Privacy Policy to cover what friends can see about you on the Weekly Leaderboard" },
    ],
  },
  {
    version: "1.1.0",
